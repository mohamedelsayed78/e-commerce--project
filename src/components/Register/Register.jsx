...
export default function Register() {
  ...
  return (
    <>
      ...
      <h2 className="mt-10 text-3xl font-bold text-center text-emerald-400 sm:mt-24">
        Register Now
      </h2>
      ...
      <form onSubmit={formicRegister.handleSubmit} className="max-w-lg px-4 m-10 mx-auto sm:px-6">
        {loading && (
          <div className="flex justify-center mb-5">
            <BallTriangle height={80} width={80} color="#db27" visible={true} />
          </div>
        )}
        <div className="mb-5">
          ...
          <input
            ...
            type="text"
            id="name"
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-emerald-400 focus:border-emerald-400 block w-full p-2.5"
          />
        ...
        <button
          type="submit"
          className="w-full sm:w-auto text-white bg-emerald-400 hover:bg-emerald-400 focus:ring-4 focus:outline-none focus:ring-emerald-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
          disabled={loading}
        >
          Register
        </button>
