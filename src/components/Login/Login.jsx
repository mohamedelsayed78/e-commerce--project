...
export default function Login() {
  ...
  return (
    <>
      ...
      <h2 className="mt-10 text-3xl font-bold text-center text-emerald-500 sm:mt-24">
        Login Now
      </h2>
      ...
      <form onSubmit={formicLogin.handleSubmit} className="max-w-lg px-4 m-10 mx-auto sm:px-6">
        ...
        <button
          type="submit"
          className="w-full sm:w-auto text-white bg-emerald-500 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
          disabled={loading}
        >
          Login
        </button>
