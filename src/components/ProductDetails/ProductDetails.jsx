  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center mt-60">
        <BallTriangle height={120} width={120} color="#db27" visible={true} />
      </div>
    );
  }
  ...
  return (
    <>
      <div className="grid grid-cols-[1fr_2fr] my-24">
        ...
        <div className="my-48">
          <h1 className="text-4xl font-bold text-emerald-500">{product.title}</h1>
          ...
          <p className="font-bold text-emerald-500">{product.price} EGP</p>

          <button 
          onClick={()=>addproducttoCart(product._id)}
          className="w-2/3 p-2 my-10 text-white bg-emerald-500 rounded-lg me-10">
            Add To Cart
          </button>
          <button
      ...
      <div className="mt-20">
        <h2 className="mb-5 text-2xl font-bold text-center text-emerald-500">
          Related Products
        </h2>
