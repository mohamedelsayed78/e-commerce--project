    ...
    <div className="container mx-auto px-4 py-24">
      ...
      {numofCart === 0 ? (
        ...
        <div>
          ...
          <Link to="/Payment">
            <button className="text-white bg-emerald-500 hover:bg-emerald-500 focus:ring-4 focus:outline-none focus:ring-emerald-500 font-medium rounded-lg text-md w-full px-5 py-3 text-center block my-3">
              Checkout
            </button>
          </Link>
          {/* Cart Footer */}
