    ...
    {token? 
      ...
      <div className="  footer  bg-[#f0f3f2] py-10 px-3">
        <div className="footer max-w-screen-xl mx-auto px-3">
          <div className="text">
            <h2 className="text-emerald-500 text-2xl mb-3 font-bold">
          ...
          <div className="input flex flex-wrap gap-3 justify-between py-5 border-b-2 border-gray-300">
            <input
              type="email"
              placeholder="Email"
              className="block w-full md:w-[73%] text-md text-gray-900 bg-transparent border-2 border-gray-600 rounded-md focus:outline-none focus:ring-0 focus:border-emerald-500 p-3"
            />
            <button className="w-full md:w-1/4 text-white bg-emerald-500 hover:bg-black focus:ring-4 focus:outline-none focus:ring-emerald-500 font-medium rounded-md text-md text-center p-3">
              Share App Link
            </button>
          </div>
